...
DRONH = 1  # размеры дрона. не используются
DRONW = 2.5  # размеры дрона. не используются
...
def Adjust(st_degr=10):  # встать параллельно препятствию . не ставить параметр меньше 10
    ...
    if dist == -1:  # если справа ничего - посмотреть что слева
        ...
        Adjust(st_degr-10)  # если справа ничего - посмотреть что слева
    else:
        ...
        if 0 < dist:  # #!        если есть препятствие
            Step(dist - 2)  # #!  встаем к стене на расстояние 2 м
