...
##       ## ##     ## ##        ##########   ######## ########  ####    ##     #######  ##     ##
    ...
    Control+o; Control+O - загрузка поверх нынешней карты существующей
    Control+S, Control+s - окончательное сохранение карты с закрытием программы
    Shift+S, Shift+s - промежуточное сохранение карты. не отменяет авто сохранение
