...
d88P  Y88b Y8P                                888
Y88b.                                         888
 "Y888b.   888 88888b.d88b.          .d8888b  88888b.   .d88b.  888  888  888
    "Y88b. 888 888 "888 "88b         88K      888 "88b d88""88b 888  888  888
      "888 888 888  888  888         "Y8888b. 888  888 888  888 888  888  888
Y88b  d88P 888 888  888  888              X88 888  888 Y88..88P Y88b 888 d88P
 "Y8888P"  888 888  888  888 88888888 88888P' 888  888  "Y88P"   "Y8888888P"



         УПРАВЛЕНИЕ:
    ЛКМ + тянуть - движение карты
    ПКМ - сброс перемещения карты, дрон по центру
    СКМ - начать  движение в указанную точку
    Колесо мыши - изменение масштаба
    Tab - показывать значение сенсора
...
while DESTROY is False:
    ...
    if SensUPDATE and DESTROY:
        ...
        map_canvas.move('move', (DX - DRONEX) * Masshtabe, (DY - DRONEY) * Masshtabe)
        map_canvas.delete('sens')
        for sens in DRONE_SENSORS:
            xy, _, dst, ang_range = sens
            dst *= Masshtabe
            map_canvas.create_arc(300 - dst, 300 - dst, 300 + dst, 300 + dst,
                                  start=DIRECTION_XY + xy - ang_range / 2 - 90,
                                  extent=ang_range, tags=['map', 'obj', 'sens', 'end'])
        ...
        #                        300-0.5*Masshtabe*cos(DIRECTION_XY / 180 * pi+ pi), 300, 300, tags=['map'], fill='red',
        #                        width=2)
        map_canvas.create_image(300, 300, image=img, tags=['map', 'obj', 'end'])
        # map_canvas.move('obj', DXM * Masshtabe, DYM * Masshtabe)

        map_canvas.create_text(300, 300, text='DESTROY', anchor='center', tags='map',
                               font=Font(size=80), fill='red')

        map_canvas.move('end', DXM * Masshtabe, DYM * Masshtabe)
